...
class App < Sinatra::Base
  ...
  def self.form
    "<form action='/' method='post' \
      ...
      "<option value='dall-e-3' selected='selected'>" \
      "DALL-E 3</option>" \
      "</select><br>" \
  ...
  post '/' do
    begin
      ...
      # Step 2: Convert the text to prompts
          ...
          parameters: {
            ...
            messages: [{
              ...
              content: "Please consider this full text following " \
                ...
                "'prompts' optimized for DALL-E image generation." \
                "They should be one short sentence each." \
      ...
      unless generated_images.length >= @cache[:prompts].length
        @cache[:prompts].each_with_index do |prompt, i|
          ...
          image_response = App.open_ai.images.generate(
            parameters: {
              ...
              size: "1024x1024",
              quality: "standard",
              prompt: App.sketch_prompt(prompt)
            }
          )
